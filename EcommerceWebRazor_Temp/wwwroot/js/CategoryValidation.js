document.addEventListener('DOMContentLoaded', function () { //esto hace que se ejecute despues que todo el html este cargado
    ...
    const nameInput = document.getElementById('Category_Name');//campos de texto donde el usuario escribe el campo de categorria
    const displayInput = document.getElementById('Category_Display');//campo del numero de display 
    const nameError = document.getElementById('Category_Name-error');//spans div donde se muestra los erorres 
    const displayError = document.getElementById('Category_Display-error');//spans o divs ......
